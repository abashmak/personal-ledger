...
public class GetLedgerAsync extends AsyncTask<Void, Long, Boolean>
{
	private final static String TAG = "PL-GetLedger";
	private WrapperActivity mActivity;
    private String mPath;
    private ApiResult mResult;

    public GetLedgerAsync(WrapperActivity activity, String dropboxPath)
    {
    	mActivity = activity;
        mPath = dropboxPath;
